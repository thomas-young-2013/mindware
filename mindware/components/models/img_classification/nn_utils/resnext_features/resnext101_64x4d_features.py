...
https://github.com/Cadene/pretrained-models.pytorch/blob/master/pretrainedmodels/models/resnext_features/resnext101_64x4d_features.py
"""
...
def get_resnext101_64x4d_features(grayscale=False):
    resnext101_64x4d_features = nn.Sequential(  # Sequential,
        nn.Conv2d(1 if grayscale else 3, 64, (7, 7), (2, 2), (3, 3), 1, 1, bias=False),
        nn.BatchNorm2d(64),
        nn.ReLU(),
    ...
    return resnext101_64x4d_features
